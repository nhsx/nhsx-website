    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casestudypage_hero_image', to='images.NHSXImage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_case_studies', to='case_studies.CaseStudyTag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(blank=True, help_text='A comma-separated list of tags.', through='case_studies.CaseStudyTags', to='case_studies.CaseStudyTag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='casestudypage',
