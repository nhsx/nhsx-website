    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(blank=True, help_text='Image credit', max_length=255, null=True)),
                ('alttext', models.CharField(blank=True, help_text='Alt text - good for accesibility', max_length=255, null=True, verbose_name='Alt-text')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='images.NHSXImage')),
            ],
            options={
